...
class JPEG_ICC
{
    ...
    public function SaveToICC($fname, $force_overwrite = false)
    {
        ...
        if (false === $ret || $ret < $this->icc_size) {
            throw new Exception("Write failed.\n");
        }
    }
    ...
    private function getJPEGSegmentContainsICC(&$f, $pos, $size)
    {
        ...
        return (bool) (self::ICC_MARKER == substr($f, $pos + 4, self::ICC_HEADER_LEN - 2)); // 4B offset in segment data = 2B segment marker + 2B segment size data
    }
