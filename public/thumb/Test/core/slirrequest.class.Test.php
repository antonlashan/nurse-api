...
class SLIRRequestTest extends SLIRTestCase
{
    ...
    public function setCropRatioWithXDelimiter()
    {
        ...
        $this->assertSame($request->cropRatio, ['width' => 2.0, 'height' => 1.0, 'ratio' => 2.0]);
    ...
    public function setCropRatioWithLargeWidth()
    {
        ...
        $this->assertSame($request->cropRatio, ['width' => 2000000.0, 'height' => 1.0, 'ratio' => 2000000.0]);
        $this->assertTrue($request->isCropping());
    }
    ...
    public function setCropRatioWithLargeHeight()
    {
        ...
        $this->assertSame($request->cropRatio, ['width' => 1.0, 'height' => 2000000.0, 'ratio' => 0.0000005]);
        $this->assertTrue($request->isCropping());
    }
